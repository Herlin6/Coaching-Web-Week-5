...
export interface ApiMahasiswaMahasiswa extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Jurusan: Attribute.String;
    nilais: Attribute.Relation<
      'api::mahasiswa.mahasiswa',
      'oneToMany',
      'api::nilai.nilai'
    >;
    NPM: Attribute.BigInteger;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::mahasiswa.mahasiswa',
...
export interface ApiMataKuliahMataKuliah extends Schema.CollectionType {
  ...
  attributes: {
    nama_mata_kuliah: Attribute.String;
    SKS: Attribute.Integer;
    nilais: Attribute.Relation<
